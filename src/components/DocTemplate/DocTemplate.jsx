          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              ...
              <MI id="completion-title-cause">
                <div style={{ fontSize: '11pt', marginTop: 'calc(1.5em * 10 - 112px)', paddingLeft: 'calc(1em + 1px)' }}>
              ...
              <MI id="completion-title-applicants">
                <div style={{ fontSize: '11pt', marginTop: 'calc(1.5em * 9 - 168px)', paddingLeft: 'calc(1em + 1px)' }}>
                  {(applicants || []).map(p => (
